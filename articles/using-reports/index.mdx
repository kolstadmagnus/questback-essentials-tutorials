...
date: "2021-05-10"
title: "Using reports"
lead: "Reports are how you choose to display the responses of your quest. This article gives an overview of the many things you can do with reports in Essentials."
---
...
<div className="tutorial">
  ...
  <p>In your report, click the green <UI content="Add" /> button. You will have five choices—<UI content="Add questions"/>, <UI content="Add text item"/>, <UI content="Add response log"/>, <UI content="Add section"/>, or <UI content="Add index"/>.</p>
</div>

1. **<UI content="Add questions"/>** lets you add the questions you’ve created in the designer. You can tick off questions separately or click <UI content="Select all in entire list" />.
1. **<UI content="Add text item"/>** adds a section in your report in which you can write simple text or add pictures with the Essentials text editor.
1. **<UI content="Add response log"/>** adds the response history of your quest to your report.
1. **<UI content="Add section"/>** adds a new section, allowing you to structure your report.
1. **<UI content="Add index"/>** lets you add an index to your report—a section in which you can aggregate data across several questions. You choose the index content by setting the weight of your questions.
...
<div className="tutorial">
  <h3>How to let (or deny) users from applying filters</h3>
